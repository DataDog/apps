...
- `size` (optional, `lg`, `md`, or `sm`): The width of the modal. The height of the modal is automatically adjusted to fit the content up to a maximum of 80% of the viewport height.
